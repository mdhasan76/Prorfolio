    ...
    >
      {() => (
        <div className=" hero text-center text-white h-full">
          ...
          <div>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-normal">
              MD HASAN MIA
            </h1>
            ...
            <a
              href="#contact"
              className="text-[#ff014f] p-3 bg-white rounded text-lg font-medium mt-4 inline-block"
            >
              Contact Me
            </a>
          </div>
